...
import com.eduside.examdicodingfundamental.databinding.ActivityMerkuriusBinding
import com.eduside.examdicodingfundamental.main.MainActivity

class MerkuriusActivity : AppCompatActivity() {

    private lateinit var binding : ActivityMerkuriusBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMerkuriusBinding.inflate(layoutInflater)
