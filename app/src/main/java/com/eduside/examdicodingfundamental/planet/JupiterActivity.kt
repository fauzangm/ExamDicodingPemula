...
import com.eduside.examdicodingfundamental.databinding.ActivityJupiterBinding
import com.eduside.examdicodingfundamental.main.MainActivity

class JupiterActivity : AppCompatActivity() {
    private lateinit var binding : ActivityJupiterBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityJupiterBinding.inflate(layoutInflater)
