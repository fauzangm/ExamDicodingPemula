...
import com.eduside.examdicodingfundamental.databinding.ActivityMatahariBinding
import com.eduside.examdicodingfundamental.main.MainActivity

class MatahariActivity : AppCompatActivity() {
    private lateinit var binding : ActivityMatahariBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMatahariBinding.inflate(layoutInflater)
