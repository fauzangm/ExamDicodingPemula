...
import com.eduside.examdicodingfundamental.databinding.ActivityUranusBinding
import com.eduside.examdicodingfundamental.main.MainActivity

class UranusActivity : AppCompatActivity() {
    private lateinit var binding:ActivityUranusBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityUranusBinding.inflate(layoutInflater)
