...
import com.eduside.examdicodingfundamental.databinding.ActivitySaturnusBinding
import com.eduside.examdicodingfundamental.main.MainActivity

class SaturnusActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySaturnusBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySaturnusBinding.inflate(layoutInflater)
