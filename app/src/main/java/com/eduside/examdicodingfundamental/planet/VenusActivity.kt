...
import com.eduside.examdicodingfundamental.databinding.ActivityVenusBinding
import com.eduside.examdicodingfundamental.main.MainActivity

class VenusActivity : AppCompatActivity() {
    private lateinit var binding : ActivityVenusBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityVenusBinding.inflate(layoutInflater)
